  ...
  datahot(){
    ...
    this.sukienService.findByhot().subscribe(data=>{
      ...
      this.x= setInterval(()=>{
        ...
        $("#days").html(days + "<span style='font-size: 30px'>Days</span>");
        $("#hours").html(hours + "<span style='font-size: 30px'>Hours</span>");
        $("#minutes").html(minutes + "<span style='font-size: 30px'>Minutes</span>");
        $("#seconds").html(seconds + "<span style='font-size: 30px'>Seconds</span>");
      })
    });
